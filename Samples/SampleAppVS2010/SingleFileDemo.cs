...
/*
	...
	Generated: 11/16/2011 01:12:45
*/


namespace SampleAppVS2010.SingleFileDemo
{
	/// <summary>
...
namespace SampleAppVS2010.SingleFileDemo
{
	...
	public static class EntityBase
	{
		...
		static EntityBase()
		{
			ConnectionString = "Data Source='SingleFileDemo.sdf'";
		}
...
namespace SampleAppVS2010.SingleFileDemo
{
	...
	public partial class ContactRepository : IContactRepository
	{
		...
		public void Update(System.Collections.Generic.IEnumerable<Contact> items)
		{
			...
			{
				command.CommandText = "UPDATE [Contact] SET Name = @Name, Address = @Address, City = @City, PostalCode = @PostalCode, Country = @Country, Email = @Email, Phone = @Phone WHERE Id = @Id";
				command.Parameters.Add("@Id", System.Data.SqlDbType.Int);				command.Parameters.Add("@Name", System.Data.SqlDbType.NVarChar);				command.Parameters.Add("@Address", System.Data.SqlDbType.NVarChar);				command.Parameters.Add("@City", System.Data.SqlDbType.NVarChar);				command.Parameters.Add("@PostalCode", System.Data.SqlDbType.NVarChar);				command.Parameters.Add("@Country", System.Data.SqlDbType.NVarChar);				command.Parameters.Add("@Email", System.Data.SqlDbType.NVarChar);				command.Parameters.Add("@Phone", System.Data.SqlDbType.NVarChar);				command.Prepare();
...
namespace SampleAppVS2010.SingleFileDemo
{
	...
	public partial class CustomerRepository : ICustomerRepository
	{
		...
		public void Update(System.Collections.Generic.IEnumerable<Customer> items)
		{
			...
			{
				command.CommandText = "UPDATE [Customer] SET ContactId = @ContactId, Name = @Name, Address = @Address, City = @City, PostalCode = @PostalCode, Country = @Country, Email = @Email, Phone = @Phone, Fax = @Fax WHERE Id = @Id";
				command.Parameters.Add("@Id", System.Data.SqlDbType.Int);				command.Parameters.Add("@ContactId", System.Data.SqlDbType.Int);				command.Parameters.Add("@Name", System.Data.SqlDbType.NVarChar);				command.Parameters.Add("@Address", System.Data.SqlDbType.NVarChar);				command.Parameters.Add("@City", System.Data.SqlDbType.NVarChar);				command.Parameters.Add("@PostalCode", System.Data.SqlDbType.NVarChar);				command.Parameters.Add("@Country", System.Data.SqlDbType.NVarChar);				command.Parameters.Add("@Email", System.Data.SqlDbType.NVarChar);				command.Parameters.Add("@Phone", System.Data.SqlDbType.NVarChar);				command.Parameters.Add("@Fax", System.Data.SqlDbType.NVarChar);				command.Prepare();
...
namespace SampleAppVS2010.SingleFileDemo
{
	...
	public partial class ProductRepository : IProductRepository
	{
		...
		public System.Collections.Generic.List<Product> SelectByRating(System.Decimal? Rating, int count)
		{
			...
			if (Rating != null)
			{
				command.CommandText = "SELECT TOP(" + count + ") * FROM Product WHERE Rating=@Rating";
				command.Parameters.Add("@Rating", System.Data.SqlDbType.Decimal);
				command.Parameters["@Rating"].Value = Rating != null ? (object)Rating : System.DBNull.Value;
			}
			else
		...
		public void Update(System.Collections.Generic.IEnumerable<Product> items)
		{
			...
			{
				command.CommandText = "UPDATE [Product] SET PartNumber = @PartNumber, Ean13 = @Ean13, Name = @Name, Description = @Description, Rating = @Rating WHERE Id = @Id";
				command.Parameters.Add("@Id", System.Data.SqlDbType.Int);				command.Parameters.Add("@PartNumber", System.Data.SqlDbType.NVarChar);				command.Parameters.Add("@Ean13", System.Data.SqlDbType.NVarChar);				command.Parameters.Add("@Name", System.Data.SqlDbType.NVarChar);				command.Parameters.Add("@Description", System.Data.SqlDbType.NVarChar);				command.Parameters.Add("@Rating", System.Data.SqlDbType.Decimal);				command.Prepare();
...
namespace SampleAppVS2010.SingleFileDemo
{
	...
	public partial class StockRepository : IStockRepository
	{
		...
		public void Update(System.Collections.Generic.IEnumerable<Stock> items)
		{
			...
			{
				command.CommandText = "UPDATE [Stock] SET ProductId = @ProductId, Quantity = @Quantity, LastUpdated = @LastUpdated WHERE Id = @Id";
				command.Parameters.Add("@Id", System.Data.SqlDbType.Int);				command.Parameters.Add("@ProductId", System.Data.SqlDbType.Int);				command.Parameters.Add("@Quantity", System.Data.SqlDbType.Int);				command.Parameters.Add("@LastUpdated", System.Data.SqlDbType.DateTime);				command.Prepare();
