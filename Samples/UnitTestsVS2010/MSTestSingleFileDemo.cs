...
/*
	...
	Generated: 11/16/2011 00:44:45
*/


using SampleAppVS2010.SingleFileDemo;

namespace UnitTestsVS2010.MSTestSingleFileDemo
{
...
namespace UnitTestsVS2010.MSTestSingleFileDemo
{
	...
	public class DataAccessTestBase
	{
		...
		{
			var databaseFile = @"C:\Users\Christian\AppData\Local\SQLCE Code Generator\MSTestSingleFileDemo.sdf_" + System.Guid.NewGuid().ToString().Replace("{", string.Empty).Replace("}", string.Empty) + ".sdf";
...
namespace UnitTestsVS2010.MSTestSingleFileDemo
{
	...
	public class DatabaseFileTest : DataAccessTestBase
	{
		...
		public void CreateDatabaseTest()
		{
			...
			EntityBase.ConnectionString = @"Data Source='C:\Users\Christian\AppData\Local\SQLCE Code Generator\MSTestSingleFileDemo.sdf'";
			EntityBase.Connection.Dispose();
			EntityBase.Connection = null;
		}
	}
